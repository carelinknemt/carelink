    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-4 p-4 lg:gap-6 lg:p-6">
                <div>
                    <h2 className="text-xl font-semibold tracking-tight">Service Rates</h2>
                    <p className="text-sm text-muted-foreground">Manage base dispatch fees and per-mile charges for Humboldt County</p>
                </div>
