...
class UpdateTripRequestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payer' => ['sometimes', 'required', 'string', 'max:255'],
            'transport_type' => ['sometimes', 'required', 'string', 'max:255'],
            ...
            'passenger_phone_number' => ['sometimes', 'nullable', 'string', 'max:32'],
            'passenger_email' => ['sometimes', 'nullable', 'email', 'max:255'],
            ...
            'requested_by_phone_number' => ['sometimes', 'nullable', 'string', 'max:32'],
            ...
            'pickup_contact_phone_number' => ['sometimes', 'nullable', 'string', 'max:32'],
            ...
            'dropoff_contact_phone_number' => ['sometimes', 'nullable', 'string', 'max:32'],
