...
use App\Http\Controllers\Carelink\RefundPolicyController;
...
use App\Http\Controllers\Carelink\SmsController;
...
Route::get('/refund-policy', RefundPolicyController::class)->name('refund-policy');
Route::get('/sms-terms', SmsController::class)->name('sms-terms');
