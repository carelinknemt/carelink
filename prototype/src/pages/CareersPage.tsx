          ...
          <div className="p-8 sm:p-12 border-b border-slate-100">
            ...
            <div className="mt-8 space-y-6">
              <div className="p-6 rounded-2xl border border-slate-200 bg-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <h3 className="text-lg font-black text-slate-900">NEMT Driver (Non-Emergency Medical Transport)</h3>
                  <p className="text-xs text-slate-500 mt-1">Full-Time / Part-Time &bull; Eureka, CA Headquarters</p>
              ...
              <div className="p-6 rounded-2xl border border-slate-200 bg-slate-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <h3 className="text-lg font-black text-slate-900">Dispatch Coordinator</h3>
                  <p className="text-xs text-slate-500 mt-1">Full-Time &bull; Eureka, CA Headquarters</p>
                  <ul className="mt-3 space-y-1.5 text-sm text-slate-600">
                    <li className="flex items-center gap-2">
                      <CheckCircle className="h-4 w-4 text-[#E64A19]" />
            ...
            <form className="mt-6 space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input type="text" className="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm outline-none transition-all focus:border-[#E64A19] focus:ring-2 focus:ring-orange-100 bg-white" placeholder="Jane Doe" required />
                </div>
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-slate-700">Email Address</label>
                  <input type="email" className="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm outline-none transition-all focus:border-[#E64A19] focus:ring-2 focus:ring-orange-100 bg-white" placeholder="jane@example.com" required />
                </div>
              </div>
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">Phone Number</label>
                <input type="tel" className="w-full rounded-xl border border-slate-300 px-4 py-2.5 text-sm outline-none transition-all focus:border-[#E64A19] focus:ring-2 focus:ring-orange-100 bg-white" placeholder="(555) 123-4567" required />
              </div>
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700">Cover Letter / Interest</label>
                <textarea rows={4} className="w-full rounded-xl border border-slate-300 px-4 py-3 text-sm outline-none transition-all focus:border-[#E64A19] focus:ring-2 focus:ring-orange-100 bg-white resize-none" placeholder="Tell us why you'd be a great fit for Carelink..." required />
              </div>
