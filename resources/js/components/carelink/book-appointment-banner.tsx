    ...
    return (
        <div className="relative z-40 w-full drop-shadow-2xl">
            <div className="grid grid-cols-1 overflow-hidden rounded-2xl sm:rounded-3xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.3)] lg:grid-cols-12 bg-white border border-white/20 ring-1 ring-black/10">
                ...
                <div className="bg-slate-50 p-5 sm:p-7 lg:p-9 lg:col-span-5 flex flex-col items-center justify-center text-center border-t lg:border-t-0 lg:border-l border-slate-200">
