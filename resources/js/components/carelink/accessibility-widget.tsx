                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                                    {[
                                        ...
                                        return (
                                            <button
                                                key={p.title}
                                                onClick={() => applyProfile(p.config as Partial<AccessibilitySettings>)}
                                        ...
                                        {(['100%', '110%', '120%', '130%', '140%', '150%'] as const).map((sz) => (
                                            <button
                                                ...
                                                className={`py-1.5 rounded-xl font-black text-[10px] transition-all text-center ${
                                                    settings.fontSize === sz ? 'bg-[#E64A19] text-white shadow-sm' : 'text-slate-400 hover:text-white'
                                                }`}
                                            >
                                                {sz}
                                            </button>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-1 bg-slate-950 p-1 rounded-2xl border border-slate-800">
                                        {[
                                            ...
                                            <button
                                                key={lh.id}
                                                onClick={() => updateSetting('lineHeight', lh.id as 'normal' | 'relaxed' | 'loose')}
                                                className={`py-1.5 rounded-xl font-bold text-[10px] transition-all text-center ${
                                                    settings.lineHeight === lh.id ? 'bg-[#E64A19] text-white shadow-sm' : 'text-slate-400 hover:text-white'
                                                }`}
                                            >
                                                {lh.label}
                                            </button>
                                    ...
                                    <div className="grid grid-cols-4 gap-1 bg-slate-950 p-1 rounded-2xl border border-slate-800">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`py-1.5 rounded-xl font-bold text-[10px] transition-all text-center ${
                                                    settings.speechRate === sp.rate ? 'bg-[#E64A19] text-white shadow-sm' : 'text-slate-400 hover:text-white'
                                                }`}
                                            >
                                                {sp.label}
                                            </button>
